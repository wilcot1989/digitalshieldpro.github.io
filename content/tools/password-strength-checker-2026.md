...
<div style="background:linear-gradient(135deg,#1e3a5f 0%,#1a2744 100%);border:1px solid #2563eb;border-radius:10px;padding:20px 24px;margin:32px 0;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
  ...
  <a href="/go/nordpass" rel="nofollow sponsored" style="background:#2563eb;color:#fff;padding:11px 22px;border-radius:7px;font-weight:600;text-decoration:none;white-space:nowrap;font-size:0.9rem;">Try NordPass Free →</a>
</div>
...
Or if you want the best team and family solution: [try 1Password](/go/1password) — 14-day free trial, no credit card required.
