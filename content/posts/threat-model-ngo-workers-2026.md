---
title: "Threat Model for NGO and Aid Workers 2026"
date: 2026-08-17T09:00:00+02:00
lastmod: 2026-08-17T09:00:00+02:00
draft: false
description: "NGO staff in human rights, refugee aid, and democracy work face state-level adversaries. Here is the threat model and stack I would build for them."
keywords: ["NGO security", "aid worker privacy", "human rights defender threat model", "humanitarian security 2026", "refugee aid worker security", "activist NGO stack"]
categories: ["threat-modeling"]
tags: ["threat model", "NGO", "human rights", "humanitarian", "activist", "privacy"]
affiliate: true
...
products:
  ...
  - name: "Mullvad VPN"
    ...
    price: "€5.00/mo"
  - name: "Signal"
    url: "https://go.digitalshieldpro.com/signal"
    price: "Free"
faq:
  - q: "Is NGO workers and humanitarian field staff actually worth setting up in 2026?"
    a: "For the audience this article targets — NGO program staff, aid workers, human rights defenders, refugee-focused volunteers — yes, with caveats. The threat profile justifies the time cost: host-country intelligence services, organised criminal networks targeting beneficiaries, and well-resourced state actors hostile to the NGO mission. For users with a lighter threat model, the answer is more nuanced. I lay out a calibration matrix later in this article so you can decide based on your situation rather than blanket advice."
  ...
  - q: "Will switching break my existing workflows?"
    a: "Some, yes. I am honest about this throughout the article. Specifically: shared documents with non-NGO workers and humanitarian field staff-using colleagues become harder, calendar invites to non-encrypted-calendar users degrade to plaintext, and password recovery becomes your problem rather than 'click forgot password'. None of these are dealbreakers but they are real tradeoffs."
  ...
  - q: "What is the single biggest mistake people make here?"
    a: "Treating tools as a substitute for behaviour. Ngo workers and humanitarian field staff can be set up perfectly and still fail because the user emails the same sensitive content from a different account, or installs malware on the device, or syncs to a backup that is not encrypted. The tooling reduces risk only if behaviour matches the tooling. I cover the behaviour layer in section 6."
---
I have spent the past several months testing tooling and workflows specifically for NGO workers and humanitarian field staff. This article is the writeup — what I tried, what I kept, and what I would tell a friend in this situation tonight.

If you are part of the audience this is written for — NGO program staff, aid workers, human rights defenders, refugee-focused volunteers — the goal here is not to dump every privacy tool on your doorstep. It is to give you a calibrated stack that matches the realistic threat profile.
...
> **Quick answer:** NGO staff in human rights, refugee aid, and democracy work face state-level adversaries. Here is the threat model and stack I would build for them.

## TL;DR — What I'd Tell You in 90 Seconds

If you are reading this on a coffee break and just want the answer:

- The core threat for NGO workers and humanitarian field staff is: **host-country intelligence services, organised criminal networks targeting beneficiaries, and well-resourced state actors hostile to the NGO mission**.
...
For the VPN that hides connections: <a href="https://go.digitalshieldpro.com/mullvad" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View Mullvad VPN</a>
...
This article is targeted at **NGO program staff, aid workers, human rights defenders, refugee-focused volunteers**. If you are not in that group, the advice still works but it is over-engineered for everyday use. I will flag the rows in section 4 where you can scale down.
...
Before tools, the threat model. Here is what realistically matters for NGO workers and humanitarian field staff in 2026:
...
I use [Mullvad VPN](/posts/mullvad-vpn-review-2026/) because:
...
<a href="https://go.digitalshieldpro.com/mullvad" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View Mullvad VPN</a>

### Step 3 — Hardware-backed 2FA

Software TOTP (Authy, Google Authenticator) is fine for normal accounts. For NGO workers and humanitarian field staff, hardware-backed 2FA matters more because the attacker model includes targeted phishing.
...
| Ngo workers and humanitarian field staff (this article's audience) | ProtonMail Unlimited | Mullvad always-on | YubiKey + backup YubiKey | 1Password Families or Bitwarden | Yes — Incogni or DeleteMe | Tresorit or Proton Drive |
...
A counterweight to the recommendations: things I would not bother with for NGO workers and humanitarian field staff, despite seeing them recommended elsewhere.
...
For NGO workers and humanitarian field staff, the practical stack is encrypted email + always-on no-log VPN + hardware 2FA + password manager + data broker removal + encrypted cloud storage. Total cost around €20-25/month, total setup around one afternoon, total maintenance around 30 minutes per month.
...
For the VPN that hides your connections: <a href="https://go.digitalshieldpro.com/mullvad" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View Mullvad VPN</a>
