---
title: 'Librem 5 review 2026: a Linux phone after three years of patches'
date: 2026-08-11
lastmod: 2026-08-11
last_updated: 2026-08-11
draft: false
description: 'I lived with a Librem 5 for three months in 2026. Honest review covering battery, calls, app gap, and whether Linux phones are usable yet.'
...
- 'device-security'
- 'encryption'
- 'librem-5-review-2026'
keywords:
- 'librem 5 review 2026'
- 'librem 5 review 2026 2026'
- 'librem 5 review 2026 review'
- 'privacy'
- 'encryption'
...
---
The Librem 5 is the most ideologically pure phone I have ever used and the most frustrating.

I bought a Librem 5 in early 2026 and used it as my only phone for three months. Here is the honest review.
...
> **Quick answer:** I lived with a Librem 5 for three months in 2026. Honest review covering battery, calls, app gap, and whether Linux phones are usable yet.
>
...
A phone running PureOS, a Debian-based Linux distribution, with hardware kill switches for camera, microphone, modem, and WiFi. No Google. No Apple. No Android compatibility layer that matters.
...
Three physical switches for camera and mic, WiFi and Bluetooth, and modem and GPS. Flip them and the silicon is electrically disconnected. The only phone with this level of physical control I know of in 2026.
...
Six to nine hours with the modem on. Three to four with active GPS. Substantially worse than any Android. The hardware was launched in 2019 and the silicon shows its age.
...
Calls work. SMS works. MMS is unreliable. RCS does not exist. Voicemail works on most carriers. Hand-off between cell towers is occasionally rough — about one dropped call per week of heavy use.
...
There is no banking app. There is no Uber. There is no Spotify desktop client that fits the small screen well. You compose your phone life from web apps and a few native GTK applications. It is liberating and limiting.
...
Email, calendar, maps, and messaging all work via web or GTK apps. Photos work. Browsing is fine. Anything that requires SafetyNet, push notifications via FCM, or proprietary SDKs simply will not be there.
...
## Compared to a Pinephone

Pinephone is cheaper and has a more active community. Librem 5 has the kill switches, a polished software stack, and direct vendor support. Different products at different price points.
...
Hobbyists, hardcore privacy users with patience, and developers who want to contribute. Not your parents, not your partner, and not yourself if you rely on a banking app for daily life. Watch the pace of patches before committing.
