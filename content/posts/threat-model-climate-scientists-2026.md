---
title: "Threat Model for Climate Scientists 2026"
date: 2026-08-16T09:00:00+02:00
lastmod: 2026-08-16T09:00:00+02:00
draft: false
description: "Climate scientists face FOI weaponization, harassment campaigns, and data theft. Here is the practical threat model and the tools that actually help."
keywords: ["climate scientist security", "scientist threat model", "researcher privacy", "FOIA harassment scientists", "academic doxing protection", "climate research security"]
categories: ["threat-modeling"]
tags: ["threat model", "scientists", "researchers", "harassment", "FOIA", "academic"]
affiliate: true
...
products:
  ...
  - name: "Mullvad VPN"
    ...
    price: "€5.00/mo"
  - name: "Tresorit"
    url: "https://go.digitalshieldpro.com/tresorit"
    price: "€10.50/mo"
faq:
  - q: "Is climate scientists and academic researchers actually worth setting up in 2026?"
    a: "For the audience this article targets — climate researchers, IPCC contributors, university faculty, policy-adjacent scientists — yes, with caveats. The threat profile justifies the time cost: coordinated harassment campaigns, weaponized FOIA requests, data theft attempts, and well-funded denial-industry research operations. For users with a lighter threat model, the answer is more nuanced. I lay out a calibration matrix later in this article so you can decide based on your situation rather than blanket advice."
  ...
  - q: "Will switching break my existing workflows?"
    a: "Some, yes. I am honest about this throughout the article. Specifically: shared documents with non-climate scientists and academic researchers-using colleagues become harder, calendar invites to non-encrypted-calendar users degrade to plaintext, and password recovery becomes your problem rather than 'click forgot password'. None of these are dealbreakers but they are real tradeoffs."
  ...
  - q: "What is the single biggest mistake people make here?"
    a: "Treating tools as a substitute for behaviour. Climate scientists and academic researchers can be set up perfectly and still fail because the user emails the same sensitive content from a different account, or installs malware on the device, or syncs to a backup that is not encrypted. The tooling reduces risk only if behaviour matches the tooling. I cover the behaviour layer in section 6."
---
I have spent the past several months testing tooling and workflows specifically for climate scientists and academic researchers. This article is the writeup — what I tried, what I kept, and what I would tell a friend in this situation tonight.

If you are part of the audience this is written for — climate researchers, IPCC contributors, university faculty, policy-adjacent scientists — the goal here is not to dump every privacy tool on your doorstep. It is to give you a calibrated stack that matches the realistic threat profile.
...
> **Quick answer:** Climate scientists face FOI weaponization, harassment campaigns, and data theft. Here is the practical threat model and the tools that actually help.

## TL;DR — What I'd Tell You in 90 Seconds

If you are reading this on a coffee break and just want the answer:

- The core threat for climate scientists and academic researchers is: **coordinated harassment campaigns, weaponized FOIA requests, data theft attempts, and well-funded denial-industry research operations**.
...
For the inbox itself: <a href="https://go.digitalshieldpro.com/protonmail" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View ProtonMail Plus</a>

For the VPN that hides connections: <a href="https://go.digitalshieldpro.com/tresorit" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View Tresorit</a>
...
This article is targeted at **climate researchers, IPCC contributors, university faculty, policy-adjacent scientists**. If you are not in that group, the advice still works but it is over-engineered for everyday use. I will flag the rows in section 4 where you can scale down.
...
Before tools, the threat model. Here is what realistically matters for climate scientists and academic researchers in 2026:
...
I use [ProtonMail Plus](/posts/protonmail-review-2026/) for primary email. The reasons:
...
<a href="https://go.digitalshieldpro.com/protonmail" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View ProtonMail Plus pricing</a>
...
I use [Tresorit](/posts/mullvad-vpn-review-2026/) because:
...
<a href="https://go.digitalshieldpro.com/tresorit" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View Tresorit</a>

### Step 3 — Hardware-backed 2FA

Software TOTP (Authy, Google Authenticator) is fine for normal accounts. For climate scientists and academic researchers, hardware-backed 2FA matters more because the attacker model includes targeted phishing.
...
| Climate scientists and academic researchers (this article's audience) | ProtonMail Unlimited | Mullvad always-on | YubiKey + backup YubiKey | 1Password Families or Bitwarden | Yes — Incogni or DeleteMe | Tresorit or Proton Drive |
...
A counterweight to the recommendations: things I would not bother with for climate scientists and academic researchers, despite seeing them recommended elsewhere.
...
For climate scientists and academic researchers, the practical stack is encrypted email + always-on no-log VPN + hardware 2FA + password manager + data broker removal + encrypted cloud storage. Total cost around €20-25/month, total setup around one afternoon, total maintenance around 30 minutes per month.
...
For the VPN that hides your connections: <a href="https://go.digitalshieldpro.com/tresorit" class="cta-affiliate" rel="nofollow sponsored noopener" target="_blank">View Tresorit</a>
