---
title: 'OPSEC basics 2026: the three habits that prevent 90% of doxxing'
date: 2026-08-07
lastmod: 2026-08-07
last_updated: 2026-08-07
draft: false
description: 'I have helped six people unwind doxxing campaigns. The same three operational mistakes appear every single time. Here is the prevention playbook.'
...
keywords:
- 'opsec basics 2026'
- 'opsec basics 2026 2026'
- 'opsec basics 2026 guide'
- 'privacy'
- 'encryption'
featured_image: /images/categories/privacy-basics.svg
schema_type: Article
affiliate: true
products:
- name: incogni
...
---
OPSEC is boring habits, repeated, that close the gaps an attacker exploits.

I have helped six people recover from doxxing campaigns. Each one had ignored the same three habits. Here is the playbook that prevents most of it.
...
> **Quick answer:** I have helped six people unwind doxxing campaigns. The same three operational mistakes appear every single time. Here is the prevention playbook.
>
...
## Habit 1: separate identities by purpose

Real-name email for legal, banking, and government. A pseudonymous email for forums, dating apps, social media. A masked alias per vendor for everything that smells like marketing. Three layers, never crossed.
...
## Habit 2: photo metadata discipline

Every photo from your phone embeds GPS coordinates by default. Strip EXIF before posting. iPhone: Photos then Share then Options then Location off. Android: Photos then Share then More then Remove location. A sixty-second habit that closes one of the largest doxxing vectors.
...
## Habit 3: data broker hygiene every quarter

Run an Optery, DeleteMe, or Incogni pass every three months. Manually opt out of the worst US sites (Spokeo, BeenVerified, Whitepages, Radaris) once a year. Even at 80% removal, your name no longer surfaces in casual searches.
...
## Avoidable mistakes I see most

Reusing usernames across communities. Posting screenshots that show notification banners with real names. Linking the pseudonymous Twitter to the real Instagram via Linktree. Using the same profile picture on professional and pseudonymous accounts.
...
Cell-tower metadata leaks home and work locations to anyone who can subpoena it. Most adversaries cannot subpoena. Most adversaries can read your Instagram check-ins. Closing the easy leaks first.
...
## Public records and how to live with them

In the US most home addresses are public via property records. The fix is not the records — it is breaking the chain from your name on a forum to those records. Use a CMRA address or P.O. Box for any public-facing registration.
...
## If you are already doxxed

Document what is exposed (screenshots, URLs, archives). File DMCA or doxxing takedown requests with the host. Ask Google to deindex via the personal-information removal form. Lock down what you can; accept that some traces will remain.
...
OPSEC is not paranoia. It is a routine, like brushing your teeth, that quietly prevents the failure mode that is otherwise hard to recover from. Once the habits are habits, they cost nothing.
