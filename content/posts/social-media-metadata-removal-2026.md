---
title: 'Social media metadata removal 2026: my Sunday cleanup'
date: 2026-08-09
lastmod: 2026-08-09
last_updated: 2026-08-09
draft: false
description: 'I run a 20-minute weekly metadata cleanup across my social profiles. Honest playbook covering EXIF, geotags, follower exports, and location history.'
...
tags:
- 'opsec'
- 'social-media-metadata-removal-2026'
- 'privacy'
- 'guide'
keywords:
- 'social media metadata removal 2026'
- 'social media metadata removal 2026 2026'
- 'social media metadata removal 2026 guide'
- 'privacy'
- 'encryption'
...
---
Social media metadata is the privacy leak you do not see — until someone shows it to you.

I run a 20-minute weekly cleanup across every social profile I have. Here is exactly what I check and why.
...
> **Quick answer:** I run a 20-minute weekly metadata cleanup across my social profiles. Honest playbook covering EXIF, geotags, follower exports, and location history.
>
...
## EXIF and geotags on uploads

Instagram and Facebook strip EXIF on upload. Twitter, X, and Mastodon do not always. I strip EXIF locally before posting using ExifTool or the Photos app's Remove Location option.
...
## Tagged photos by other people

Friends tag you in their photos with their EXIF and their location. Set your profile so tags require approval. Periodically untag yourself from old check-ins.
...
## Follower and friend exports

Once a month I export my friend list from Facebook and my follower list from Instagram. I diff them against last month. New followers from accounts with no avatar and zero posts get a closer look — those are usually scrapers.
...
Google Timeline (Maps) records every place your phone has been. Disable it: Maps then Settings then Location settings then Timeline off. Then delete the history. Do the same for Apple Significant Locations: Settings then Privacy and Security then Location Services then System Services then Significant Locations then Clear.
...
## Old posts that contain locations

I do a yearly sweep of my own posts for locations I no longer want public — old apartments, workplaces, vacation patterns. Delete or edit. Most platforms allow bulk deletion via Mastodon-tooter, Twitter Archive Eraser, and Instagram's bulk delete.
...
Every quarter I review the third-party apps connected to each account. Anything I have not used in 90 days gets revoked. Half of these apps still phone home for analytics even if you stopped using them.
...
After cleaning, I request reindexing through Google Search Console for my own properties and use the personal-information removal form for cached versions of deleted social posts. Removal takes one to four weeks.
...
EXIF strip on the past week's uploads. Tag review. Connected app review. Location-history audit. New-follower scan. Twenty minutes, every week, for two years now. The peace of mind is worth more than the time.
