---
title: 'Threat model for executives 2026: deepfakes and BEC'
date: 2026-07-27
lastmod: 2026-07-27
last_updated: 2026-07-27
draft: false
description: 'Executives are targeted with deepfake CEO calls and invoice fraud. Honest threat model covering personal devices, family, and the assistant with calendar access.'
...
- 'opsec'
- 'threat-model'
- 'threat-model-for-executives-2026'
- 'privacy'
keywords:
- 'threat model for executives 2026'
- 'threat model for executives 2026 2026'
- 'threat model for executives 2026 guide'
- 'privacy'
- 'encryption'
featured_image: /images/categories/threat-models.svg
schema_type: Article
affiliate: true
products:
- name: 1password
...
---
Executives are not phished by accident. They are phished because the attackers studied them for weeks.

I run security workshops for C-suite executives at mid-market companies. Here is the threat model that has held up.
...
> **Quick answer:** Executives are targeted with deepfake CEO calls and invoice fraud. Honest threat model covering personal devices, family, and the assistant with calendar access.
>
...
Adversaries: financially motivated BEC crews; nation-state collection during M&A; opportunistic ransomware; deepfake voice impersonation of the executive; family members targeted as a soft path to the principal.
...
The CEO's iPhone is the threat surface that most security programs ignore. Same hygiene as a corporate device: ADP, Lockdown Mode for travel, hardware MFA on email, no SMS-based 2FA on banking.
...
Spouse and children are addressed in the program. Their accounts protect the principal. A spear-phisher who compromises a teenager's gaming account often ends up inside the family iCloud.
...
The executive assistant is the access broker. They schedule calls, see the calendar, and read inbound mail. Their account hygiene is more critical than the executive's. Hardware MFA, dedicated work device, regular security training.
...
Two-person rule for any wire over a low threshold (I argue five thousand euros). Out-of-band verification — a phone call to a known number — for any new banking instructions. Domain-look-alike monitoring (a service like DomainTools or a homemade DNStwist cron).
...
Establish a verbal challenge phrase known only inside the family or executive team. Use it for any unexpected call requesting a transfer or sensitive information. Cheap, low-tech, effective.
...
Removing personal data from data brokers (Incogni, Optery, DeleteMe). Keeping the executive's home address out of corporate filings. Privacy-respecting domain registration.
...
Travel laptop with no historical data. Burner phone in some jurisdictions. Brief on what to do at a hostile border. The same playbook lawyers use, because the attack surface is similar.
