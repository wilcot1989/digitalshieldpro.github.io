---
title: 'Android sandboxing 2026: Shelter, Insular, work profiles'
date: 2026-08-03
lastmod: 2026-08-03
last_updated: 2026-08-03
draft: false
description: 'I tested every Android sandboxing tool for three months. Honest guide to work profiles, Shelter, Insular, and GrapheneOS user profiles.'
author: 'James Mitchell'
author_bio: 'Cybersecurity analyst with 10+ years of hands-on experience testing VPNs, antivirus software, and privacy tools.'
categories:
- device-security
tags:
- 'android-sandboxing-2026'
- 'device-security'
- 'encryption'
- 'privacy'
keywords:
- 'android sandboxing 2026'
- 'android sandboxing 2026 2026'
- 'android sandboxing 2026 guide'
- 'privacy'
- 'encryption'
...
---
Android sandboxing tools are powerful and almost completely undocumented for privacy users.

I ran four sandboxing approaches on the same phone for three months. Here is what each one isolates and what each one leaks.
...
> **Quick answer:** I tested every Android sandboxing tool for three months. Honest guide to work profiles, Shelter, Insular, and GrapheneOS user profiles.
>
...
## The Android security model in one paragraph

Each app runs in its own UID-isolated sandbox. Permissions gate access to user data. Profiles add another layer above the app sandbox — a separate set of accounts, apps, and data living next to your main profile.
...
## Work profiles via Shelter

Shelter creates an Android Enterprise managed profile and acts as the device-policy controller. Apps installed inside it cannot see contacts, files, or accounts in your main profile. The badge in the launcher tells you which profile an app belongs to.
...
Same architecture, different UI. Insular (formerly Island) is the maintained fork. Pick whichever you find friendlier — feature parity is close in 2026.
...
GrapheneOS supports up to 32 secondary user profiles, each with its own data, apps, and even network policy. Switching between them is a full user switch — closer to a different account than to a sandbox.
...
Work profile: separating personal from semi-trusted apps (Facebook, TikTok, banking apps you do not love). User profile: separating threat models (everyday vs travel vs experiment). They compose: a user profile with a work profile inside it.
...
GrapheneOS lets you assign different network and Internet permissions per profile. Combine that with per-app firewalls and you can have an Internet-blocked Facebook in a sandboxed profile that still receives notifications via UnifiedPush.
...
Switching between user profiles requires re-authentication and is slower than a work profile toggle. For frequent switching use work profiles. For rare-but-critical isolation (travel, journalism) use a user profile.
...
Main profile: trusted apps, banking, password manager. Work profile (Shelter) inside main: social media and one suspicious vendor app. Travel profile (GrapheneOS user profile): only the apps I need on a trip, network-fenced.
