---
title: 'Threat model for lawyers 2026: privilege and your phone'
date: 2026-07-24
lastmod: 2026-07-24
last_updated: 2026-07-24
draft: false
description: 'Lawyers handle privileged communications on devices designed to back up to the cloud. Honest threat model and a stack that survives subpoenas and breaches.'
...
tags:
- 'threat-model'
- 'threat-model-for-lawyers-2026'
- 'opsec'
- 'privacy'
keywords:
- 'threat model for lawyers 2026'
- 'threat model for lawyers 2026 2026'
- 'threat model for lawyers 2026 guide'
- 'privacy'
- 'encryption'
...
---
Attorney-client privilege is fragile against the default settings on a brand-new iPhone.

I work with lawyers in three jurisdictions on their digital security. Here is the threat model I have settled on and the stack I recommend.
...
> **Quick answer:** Lawyers handle privileged communications on devices designed to back up to the cloud. Honest threat model and a stack that survives subpoenas and breaches.
>
...
Adversaries: opposing counsel via legitimate e-discovery; targeted attackers via spear phishing; passive surveillance from cloud providers under legal request; loss or theft of mobile devices; insider risk from contractors and vendors.
...
Proton Mail for privileged communications with custom domain DKIM and DMARC at p=reject. Distinct mailboxes per matter where possible. PGP for cross-firm exchange when the other side supports it.
...
iPhone with Advanced Data Protection enabled. Lockdown Mode for high-risk matters. No iCloud backup of work email — Proton Mail handles that. Personal and work clearly separated; ideally a dedicated work device.
...
FileVault on macOS or BitLocker on Windows, both with recovery keys held by the firm IT. Boot password. Auto-lock at 5 minutes. No browser sync for work profiles.
...
Encrypted at rest in a Tresorit or Proton Drive workspace. Watermark every privileged document with the recipient's name. Disable forwarding on critical attachments where the platform supports it.
...
Signal for casual coordination. Proton Mail or a secure file portal for documents. Never SMS, never WhatsApp Business — both have metadata properties unsuited to privileged content.
...
Border crossings into the US, UK, and China demand a travel device with no privileged data, signed in to a clean Apple ID, with synced data manually pulled back over the firm VPN after entry. The just power off the phone approach is naive.
...
A written playbook for: lost device, suspected phishing, opposing counsel claiming inadvertent disclosure. Practice it once a quarter. The first time you run through it should not be the day it actually matters.
